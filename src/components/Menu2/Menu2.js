            ...
            <p className="welcome">To Brussels<p className="welcome-text">You can either choose a fixed distance that will take you over a loop course, or enter a destination adress, if you already know where to go ;-)</p> </p>
                ...
                <p className="typeParcour" onClick={ev => this.showKilom()}>How big is your will to visit ?</p>
                    <ul name="listK" className={this.state.display}>
                        <li><input className="choix-km" type="radio" name="kilometers" value="5" onInput={ev => this.setKilometers(5)}></input><label className="choix-km" htmlFor='5'>5 Km</label></li>
                        <li><input className="choix-km" type="radio" name="kilometers" value="10" onInput={ev => this.setKilometers(10)}></input><label className="choix-km" htmlFor='10'>10 Km</label></li>
                        <li><input className="choix-km" type="radio" name="kilometers" value="20" onInput={ev => this.setKilometers(15)}></input><label className="choix-km" htmlFor='15'>15 Km</label></li>
                        <li><input className="choix-km" type="radio" name="kilometers" value="15" onInput={ev => this.setKilometers(20)}></input><label className="choix-km" htmlFor='20'>20 Km</label></li>
                    </ul>
                    <label className="typeParcour lab4input" for='adress'>Your final destination:</label>
                    <input className="adress" type="text" name="adress" required size="22" value={this.state.adress} onChange={this.handleChangekilometers.bind(this)} onClick={ev => this.hideKiloM()}/>
